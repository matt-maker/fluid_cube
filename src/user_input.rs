use crate::grid::{Grid, GridPosX, GridPosY, GRID_CELL_SIZE, GRID_SIZE};
use bevy::prelude::*;
...
fn cursor_position(
    ...
    mut query: Query<(&mut GridPosX, &mut GridPosY), With<Grid>>,
) {
    ...
    if let Ok((mut grid_x, mut grid_y)) = query.get_single_mut() {
